#!/usr/bin/env bash
#  /etc/init.d/easy-deposit-api

# ***** FILL IN APPROPRIATE RUN-LEVELS, START-UP AND SHUTDOWN PRIORITIES !!! ******
# chkconfig: 2345 92 58

# Provides:          easy-deposit-api
# Short-Description: Starts the easy-deposit-api service
...
CLASS="nl.knaw.dans.easy.deposit.ServiceStarter"
ARGS=""
USER="$NAME"
