...
case class DatasetMetadata(identifiers: Option[Seq[SchemedValue]] = None,
                           ...
                           protected val alternativeIdentifiers: Option[Seq[SchemedValue]] = None,
                           protected val relations: Option[Seq[RelationType]] = None,
                           languagesOfFiles: Option[Seq[SchemedKeyValue]] = None,
                           protected val dates: Option[Seq[Date]] = None,
                           ...
                           protected val privacySensitiveDataPresent: PrivacySensitiveDataPresent = PrivacySensitiveDataPresent.unspecified,
