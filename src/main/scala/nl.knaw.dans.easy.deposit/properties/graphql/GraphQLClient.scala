 ...
 */
package nl.knaw.dans.easy.deposit.properties.graphql

import java.net.{ ConnectException, URL }

import cats.syntax.either._
import nl.knaw.dans.easy.deposit.properties.graphql.direction.PaginationDirection
import nl.knaw.dans.easy.deposit.properties.graphql.error.{ GraphQLError, GraphQLQueryError, GraphQLServiceUnavailable }
